...
- **Catalog results are bounded and verified** — npm returns at most 250 candidates per query; keyword-only packages without a DSH bundle/client manifest are skipped. Verified queries are cached briefly, and npm availability and rate limits apply.
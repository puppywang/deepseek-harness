...
export interface PiAiCompatProfile {
  ...
  /** The token-budget request field name the endpoint reads; `openai-completions`. */
  ...
  /** Whether the endpoint accepts an allowed fallback-model list; `anthropic-messages`. */

...
- **Effort memory is browser-local** — the last explicitly chosen effort per provider/model route lives in localStorage, so it does not sync across devices or browser profiles.

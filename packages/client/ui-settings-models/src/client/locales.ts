...
export const en = {
  ...
  retryAttempts: 'Model request retries',
  retryAttemptsPlaceholder: 'Up to 5 retries after the first request',
  retryAttemptsInvalid: 'Retries must be an integer from 0 to 50.',
  retryAlways: 'This provider uses always-retry mode; configure it in settings.yaml.',
  models: 'Models',
  ...
  modelAdvancedPiAi: 'Capacities and thinking',
  addModel: 'Add model',
  ...
  modelReasoningLevels: 'Thinking levels',
  modelReasoningLevel: 'Thinking level',
  modelReasoningWire: 'Wire value',
  modelReasoningWirePlaceholder: 'Value the provider expects',
  modelReasoningOffPlaceholder: 'none (supported, sends nothing)',
  addReasoningLevel: 'Add thinking level',
  removeReasoningLevel: 'Delete thinking level',
  reasoningLevelsEmpty: 'No thinking levels: the model offers no reasoning levels until one is added.',
  modelReasoningEffortsInvalid: 'Thinking levels must include one level other than off, and every level needs a wire value.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  retryAttempts: '模型请求重试次数',
  retryAttemptsPlaceholder: '首次请求后最多 5 次',
  retryAttemptsInvalid: '重试次数必须是 0 到 50 的整数。',
  retryAlways: '该提供方已启用始终重试模式；请在 settings.yaml 中配置。',
  models: '模型目录',
  ...
  modelReasoningLevels: '思考等级',
  modelReasoningLevel: '思考等级',
  modelReasoningWire: '传输值',
  modelReasoningWirePlaceholder: '提供方期望的值',
  modelReasoningOffPlaceholder: 'none（支持，发送时不带参数）',
  addReasoningLevel: '添加思考等级',
  removeReasoningLevel: '删除思考等级',
  reasoningLevelsEmpty: '未配置思考等级：该模型暂不提供思考等级。',
  modelReasoningEffortsInvalid: '思考等级必须包含一个非 off 等级，且每个等级都需要传输值。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',

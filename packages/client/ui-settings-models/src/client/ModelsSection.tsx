...
import { deriveKeyRef, protocolChoices, providerUsable, reasoningEffortLevels } from './store.ts'
...
function Loaded({ injected, renderSlot }: { injected: ModelsSectionFace; renderSlot: ModelsRenderSlot }): ReactNode {
  ...
  const reasoningLevels = reasoningEffortLevels(state.namespaces.get('llm-pi-ai'), schema)

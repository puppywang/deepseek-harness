...
export const en: Record<PluginManagerLocaleKey, string> = {
  ...
  discoverIntro: 'Popular npm packages that declare the dsh-plugin keyword and a DSH bundle or client manifest. Typing searches npm directly; results are manifest-verified.',
  discoverSearch: 'Search npm plugins',
...
export const zh: Record<PluginManagerLocaleKey, string> = {
  ...
  mutateFailed: '插件操作失败。',
  discoverTitle: '发现插件',
  discoverIntro: '来自 npm 上声明 dsh-plugin 关键字，并且通过 DSH Bundle 或 Client manifest 校验的热门插件。输入关键词会直接搜索 npm。',
  discoverSearch: '搜索 npm 插件',

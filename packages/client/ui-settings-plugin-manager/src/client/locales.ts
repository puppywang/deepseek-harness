...
export const en: Record<PluginManagerLocaleKey, string> = {
  ...
  discoverIntro: 'Popular npm packages that declare the dsh-plugin keyword and a DSH bundle or client manifest. The catalog verifies the top 250 candidates.',
...
export const zh: Record<PluginManagerLocaleKey, string> = {
  ...
  mutateFailed: '插件操作失败。',
  discoverTitle: '发现插件',
  discoverIntro: '来自 npm 上声明 dsh-plugin 关键字，并且 manifest 声明 DSH Bundle 或 Client 能力的热门社区插件。目录会校验前 250 个候选。',
  discoverSearch: '搜索插件',

...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/boot/plugin-manager': { kind: 'none', reason: 'Profile file/pnpm operations; registers nothing model-facing.' },
  ...
  'packages/client/ui-settings-plugin-manager': { kind: 'none', reason: 'Browser Settings tab for profile plugin management; registers nothing model-facing.' },
  ...
  'packages/host/plugin-manager': { kind: 'none', reason: 'Host Remote around profile file/pnpm operations; registers nothing model-facing.' },
